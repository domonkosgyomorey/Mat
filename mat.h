...
/*!
    ...
    @return An allocated matrix, which is the result, and the shape is left.row x right.col
*/
...
/*!
    ...
    @return A new allocated matrix which is the result of the operation
*/
...
/*!
    ...
    @return The allocaated matrix, which was deserialize from a file
*/
...
/*!
    ...
    @param filename the file name where the Matrix will be serialize
*/
...
/*!
    ...
    @return An allocated sub matrix of the original one
*/
